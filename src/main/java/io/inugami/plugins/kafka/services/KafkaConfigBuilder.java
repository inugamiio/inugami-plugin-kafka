...
public class KafkaConfigBuilder {
    ...
    private Class<?> resolverClass(final String value, final Class<?> defaultClass, final Class<?>[] classes) {
    ...
    public KafkaConfigBuilder setKeySerializer(final String keySerializer) {
    ...
    public KafkaConfigBuilder setValueSerializer(final String valueSerializer) {
